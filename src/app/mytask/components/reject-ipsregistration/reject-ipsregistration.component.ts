...
@Component({
  selector: 'app-reject-ipsregistration',
  templateUrl: './reject-ipsregistration.component.html',
  styleUrls: ['./reject-ipsregistration.component.scss']
})
export class RejectIPSRegistrationComponent implements OnInit {
  rejectreason: string = '';
  ...
  constructReceiptData(refNumber: any) {
    ...
    this.saveReceiptObject = {
      "pageheading": this.translateService.instant("LBL_REJECT_INSTANT_TRANSFER_REGISTRATION_RECEIPT"),
      "subHeading": this.translateService.instant("LBL_TRANSACTION_DETAILS"),
      "Description": this.translateService.instant("LBL_IPS_REG_REJECTED"),
      "keyValues": [
        {
          "subHead": "From",
          "subValue": ""
  ...
  [
    ...
    { type: 'title', value:"IPS Registration", x:80, y:35},
    ...
    { type: 'heading', value:this.translateService.instant('LBL_IPS_REG_REJECTED'), y:115},
  ...
  if(SelectedType === 'save'){
    this.pdfData.push(
      { type: 'save', value:'RejectIPSRegisteration.pdf'}
   )
  }       
   else if(SelectedType === 'print'){
    this.pdfData.push(
      { type: 'print', value:'RejectIPSRegisteration.pdf'}
   )
  }
  //   this.pdfData.push(
