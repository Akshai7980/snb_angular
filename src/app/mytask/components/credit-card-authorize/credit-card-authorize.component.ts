...
import { CreditCardShowPinComponent } from 'src/app/cards/components/credit-card-show-pin/credit-card-show-pin.component';
...
@Component({
  selector: 'app-credit-card-authorize',
  templateUrl: './credit-card-authorize.component.html',
  styleUrls: ['./credit-card-authorize.component.scss'],
})
export class CreditCardAuthorizeComponent implements OnInit {
  ...
  getAuthorizers(): void {
    ...
    this.myTaskService
      .getAuthorizers({
        ...
        funcCode: this.transferSummaryDetails.summary.functionCode,
        amount: '',
        accNo: '',
        pymntCurrency: this.transferSummaryDetails.summary.currency,
        debitCurrency: this.transferSummaryDetails.summary.currency,
      })
      .subscribe(
        (authors: any) => {
          this.isLoadingComplete = true;
        ...
        .subscribe(
          (response) => {
            ...
            if (response.dataValue.STATUS === 'Success') {
              this.cardPin = response.dataValue.CARD_PIN;
    ...
    switch (this.transferSummaryDetails.summary.subproductCode) {
      case 'CARDSTP':
        ...
        this.receiptMessage = this.showAuthorization
          ...
          : 'LBL_STOP_CARD_REQ_AUTHORIZED';
        return 'STCRDAUTH';
      case 'CARDACT':
        this.receiptMessage = this.showAuthorization
          ? 'LBL_ACTIVATE_CREDIT_CARD_SENT_TO_APPROVE'
          : 'LBL_ACTIVATE_CARD_REQ_AUTHORIZED';
        return 'ACTCRDAUTH';
      case 'CRDVWPIN':
        this.fieldDetails = {
          title: '',
        ...
        this.receiptMessage = 'LBL_VIEW_PIN_REQ_AUTHORIZED';
        return 'VWPNAUTH';
      case 'CRDWITHCH':
        this.receiptMessage = this.showAuthorization
          ? 'LBL_CHANGE_WITHDRAWAL_LIMIT_SENT_TO_APPROVE'
          : 'LBL_CHANGE_CARD_WITHDRAW_LIMIT_REQ_AUTHORIZED';
        this.fieldDetails = {
          title: '',
          isTable: 'false',
          data: '',
      ...
      case 'CRDCRELIM':
        this.receiptMessage = this.showAuthorization
          ? 'LBL_CHANGE_CREDIT_LIMIT_SENT_TO_APPROVE'
          : 'LBL_CHANGE_CARD_CREDIT_LIMIT_REQ_AUTHORIZED';
        this.fieldDetails = {
          title: '',
          isTable: 'false',
          data: '',
      ...
      case 'CARDPAY':
        ...
        this.receiptMessage = this.showAuthorization
          ...
          : 'LBL_CREDIT_CARD_PAYMENT_REQ_AUTHORIZED';
        return 'CRDPAYAUTH';
      case 'CRDREISSU':
        this.receiptMessage = this.showAuthorization
          ? 'LBL_RE_ISSUE_CARD_REQUEST_PENDING_MSG'
          : 'LBL_CARD_RE_ISSUE_REQ_AUTHORIZED';
        return 'CRDREAUTH';
      case 'CRDLIMAD':
        this.receiptMessage = this.showAuthorization
          ? 'LBL_CHANGE_LIMIT_FOR_MULTIPLE_CARD_SENT'
          : 'LBL_CARD_LIMIT_ADJ_REQ_AUTHORIZED';
        return 'CRDLMTADJAUTH';
    }
    return moduleId;
  }

  onViewPinClick() {
    this.dialog.open(CreditCardShowPinComponent, {
  ...
  constructReceiptData(refNo: string): void {
    ...
    if (this.moduleId !== 'CRDLMTADJAUTH') {
