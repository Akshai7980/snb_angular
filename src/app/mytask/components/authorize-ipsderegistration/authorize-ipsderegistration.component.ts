...
@Component({
  selector: 'app-authorize-ipsderegistration',
  templateUrl: './authorize-ipsderegistration.component.html',
  styleUrls: ['./authorize-ipsderegistration.component.scss']
})
export class AuthorizeIPSDeregistrationComponent implements OnInit {
 ...
 onClickSubmit(){
  ...
  constructReceiptData(refNumber: any, data:any) {
    ...
    this.saveReceiptObject = {
      "pageheading": this.translateService.instant("LBL_AUTHORIZE_INSTANT_TRANSFER_DEREGISTRATION_RECEIPT"),
      "subHeading": this.translateService.instant("LBL_TRANSACTION_DETAILS"),
      "Description": this.translateService.instant("LBL_IPS_DEREG_APPROVED"),
      "keyValues": [
        {
          "subHead": "From",
          "subValue": ""
  ...
  if(SelectedType === 'save'){
    this.pdfData.push(
      { type: 'save', value:'AuthorizeIPSDeRegisteration.pdf'}
   )
  }       
   else if(SelectedType === 'print'){
    this.pdfData.push(
      { type: 'print', value:'AuthorizeIPSDeRegisteration.pdf'}
   )
  }
  //   this.pdfData.push(
