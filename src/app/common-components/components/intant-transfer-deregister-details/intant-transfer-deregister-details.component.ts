...
@Component({
  selector: 'app-intant-transfer-deregister-details',
  templateUrl: './intant-transfer-deregister-details.component.html',
  styleUrls: ['./intant-transfer-deregister-details.component.scss']
})
export class IntantTransferDeregisterDetailsComponent implements OnInit {
