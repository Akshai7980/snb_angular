...
@Component({
  selector: 'app-advanced-filter-e-pay-service-inquiry',
  templateUrl: './advanced-filter-e-pay-service-inquiry.component.html',
  styleUrls: ['./advanced-filter-e-pay-service-inquiry.component.scss']
})
export class AdvancedFilterEPayServiceInquiryComponent implements OnInit {
