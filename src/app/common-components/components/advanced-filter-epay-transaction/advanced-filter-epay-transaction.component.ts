...
@Component({
  selector: 'app-advanced-filter-epay-transaction',
  templateUrl: './advanced-filter-epay-transaction.component.html',
  styleUrls: ['./advanced-filter-epay-transaction.component.scss']
})
export class AdvancedFilterEPayTransactionComponent implements OnInit {
