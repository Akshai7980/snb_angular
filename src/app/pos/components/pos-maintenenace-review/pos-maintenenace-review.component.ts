...
@Component({
  selector: 'app-pos-maintenenace-review',
  templateUrl: './pos-maintenenace-review.component.html',
  styleUrls: ['./pos-maintenenace-review.component.scss'],
})
export class PosMaintenenaceReviewComponent implements OnInit {
  url: string = '';
  ...
  constructReceiptData(refNumber: any) {
    this.receiptData = {
      ...
      msg2: 'Your PoS maintenance request is pending for approval',
