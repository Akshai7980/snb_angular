...
@Component({
  selector: 'app-mada-material-review',
  templateUrl: './mada-material-review.component.html',
  styleUrls: ['./mada-material-review.component.scss'],
})
export class MadaMaterialReviewComponent implements OnInit {
  url: string = '';
  ...
  constructReceiptData(refNumber: any) {
    this.receiptData = {
      ...
      msg2: 'Your MADA material request is pending for approval',
