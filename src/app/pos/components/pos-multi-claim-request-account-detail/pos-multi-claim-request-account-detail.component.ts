...
@Component({
  selector: 'app-pos-multi-claim-request-account-detail',
  templateUrl: './pos-multi-claim-request-account-detail.component.html',
  styleUrls: ['./pos-multi-claim-request-account-detail.component.scss'],
})
export class PosMultiClaimRequestAccountDetailComponent implements OnInit {
  dataSource: any;
  selection: any;
  dataSource2: any;
  selection2: any;
  ...
  getAccountList() {
    this.posService.getMultiClaimAccountList().subscribe(
      (res: any) => {
