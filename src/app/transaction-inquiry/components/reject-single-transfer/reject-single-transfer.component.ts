...
@Component({
  selector: 'app-reject-single-transfer',
  templateUrl: './reject-single-transfer.component.html',
  styleUrls: ['./reject-single-transfer.component.scss']
})
export class RejectSingleTransferComponent implements OnInit {
  receiptData:any;
  dataValue:any;
  hideAll = false;
