...
@Component({
  selector: 'app-sadad-moi-details-layout',
  templateUrl: './sadad-moi-details-layout.component.html',
  styleUrls: ['./sadad-moi-details-layout.component.scss']
})
export class SadadMoiDetailsLayoutComponent implements OnInit {
